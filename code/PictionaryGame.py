...
class PictionaryGame(QMainWindow):
    ...
    def __init__(self):
        ...
        # Set up menus
        main_menu = self.menuBar()  # Create a menu bar
        ...
        # clear
        clear_action = QAction(QIcon("./icons/clear.png"), "Clear", self)  # create a clear action with a png as an icon
        ...
        # brush thickness
        three_px_action = QAction(QIcon("./icons/three_px.png"), "3px", self)
